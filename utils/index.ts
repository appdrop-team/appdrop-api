import { CreateEventParams } from '../analytics';
import { CreateUserParams, UpdateUserParams } from '../auth';
...
export const ERROR_RESPONSES: {
    [key in keyof ERROR_RESPONSE_KEYS]: Projects.Base.API_Request_Error;
} = Object.freeze({
    APP_CONFIG_ERROR: {
        created: null,
...
export function ValidConfig(app_config: Projects.Base.AppConfig) {
    return (
...
export function ValidParams(
    ...
    if (params !== undefined && params !== null) {
        if (action === 'Create') {
            if (object === 'Event') {
                const create_event_params = params as CreateEventParams;
                ...
                const create_user_params = params as CreateUserParams;
