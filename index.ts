 ...
 * Object mechanics
 */
export interface AppdropObject extends Identifiable {
 ...
 */
export interface RemoteAsset extends CreateRemoteAssetParams, AppdropObject {
 ...
 * Generic User object.
 */
export interface User extends CreateUserParams, AppdropObject, Mappable {
 ...
 */
export interface PasswordReset extends CreatePasswordResetParams, AppdropObject {
...
/**
* Financial details for Accounts and Users.
*/
...
export interface CreateFinancialDetailsParams extends UpdateFinancialDetailsParams {
  ...
  /**
   * The user or account's credit cards on file.
   */
  cards: {
  ...
  /**
   * The id of the account's Stripe subscription object.
   * 
   * Note – Pro plan accounts with add-ons get a wildcard Stripe
 ...
 */
export interface InAppPurchaseReceipt extends CreateInAppPurchaseReceiptParams, AppdropObject {
 ...
 * Invoice
 */
export interface Invoice extends CreateInvoiceParams, AppdropObject {
...
/**
 * The account's credit card on file.
 * 
 * Note: The data stored on Appdrop's server is designed to help account admins
...
/**
 * Params to create an account Bank Account
 */
export interface CreateBankAccountParams extends UpdateBankAccountParams {
  ...
  /**
   * The type of account that holds the account. This can be either `individual` or `company`.
   */
...
/**
 * Params to update an account Bank Account
 */
...
/**
* An account utilizing Appdrop Saas.
*/
export interface Account extends CreateAccountParams, AppdropObject {

  /**
   * Financial details for this Appdrop Account
   */
...
export interface CreateAccountParams extends UpdateAccountParams {
  ...
  /**
   * This array includes the id of each Project that this Account owns.
   */
  project_ids: string[];
  
  /**
   * Account roles. Key is user id. Value is list of account roles
   */
  roles: {
    [key: string]: string[];
  };
...
export interface UpdateAccountParams {
  ...
  /**
   * Updates to the `account_ids` array
   */
  account_ids?: ArrayUpdateOperation;
   ...
   */
  roles?: {
    [key: string]: ArrayUpdateOperation;
  };
...
/**
 * Initial value for Appdrop Account.
 */
...
export interface Order extends
  AttachOrderPromoParams, AppdropObject, CreateOrderParams,
 ...
 */
export interface CreateOrderParams extends UpdateOrderParams {
...
* Store product
*/
export interface Product extends AppdropObject, ProductBase, ProjectScoped {
...
*/
export interface ProjectTemplate extends CreateProjectTemplateParams, AppdropObject, VersionHistory {
 ...
 */
interface AppdropProduct extends CreateAppdropProductParams, AppdropObject {
 ...
 * Software version
 */
export interface Version extends CreateVersionParams, AppdropObject {
...
export interface AppdropUIScreen extends
  AppdropObject, AppdropUIStylesMap,
...
export interface AppdropUIObject extends
  AppdropUIStylesMap, AppdropObject, UpdateAppdropUIObjectParams {
 ...
 * settings.
 */
export interface Project extends CreateProjectParams, AppdropObject {
...
export interface CreateProjectParams extends
  ...
  /**
   * The id of the account that owns this project.
   */
  account_id: string;
  ...
  /**
   * Public name displayed to Users. Defaults to the name of the Account that published the template.
   */
  copyright: string;
  ...
  /**
   * Project roles. Key is user id. Value is list of permissions
   */
  roles: {
    [key: string]: string[];
  };
 ...
 */
export interface App extends CreateAppParams, AppdropObject {
 ...
 */
export interface APIRequest extends CreateAPIRequest, AppdropObject {
 ...
 * Account query
 */
export async function queryAccountByAPIKey(db: any, decodedAPIKey: string) {
  try {
    const account_query_snapshot = await db
      .collection('accounts')
      .where('api_key', '==', decodedAPIKey)
      .get();
    if (account_query_snapshot.empty) {
      throw 'account_query_snapshot.empty';
    }
    const account = account_query_snapshot.docs[0].data();
    return account as Account;
  }
  catch (error) {
    console.log('queryAccountByAPIKey error', error);
    return null;
  }
}
 ...
 */
export type StripeCustomerType = 'accounts' | 'users';
...
export interface InitCloudAppParams extends InitAppParams {
  ...
  /**
   * Id of account (returning) or an empty string (guest)
   */
  account_id: string;
...
export interface InitCloudAppResponseBody extends InitAppResponseBody {
  ...
  /**
   * Orders created by this account's ECommerce project users.
   */
  orders: {
  ...
  /**
   * Products owned by this account's ECommerce projects
   */
  products: {
  ...
  /**
   * Map of the projects owned by the Accounts in the workspace
   */
  projects: {
  ...
  /**
   * Active store promos owned by this account
   */
  promos: {
  ...
  /**
   * Map of all the minted project users in the scope of this Account. Key is the id.
   * 
 ...
 */
export interface Promo extends CreatePromoParams, AppdropObject, ProjectScoped {
 ...
 */
export interface Interest extends CreateInterestParams, AppdropObject {
 ...
 * In App Purchase
 */
export interface InAppPurchase extends CreateInAppPurchaseParams, AppdropObject {
 ...
 * Post
 */
export interface Post extends CreatePostParams, AppdropObject {
 ...
 * Thread of users
 */
export interface Thread extends CreateThreadParams, AppdropObject {
...
export interface ThreadActivity {
  ...
  /**
   * Unix timestamp. When user first joined (or, if private, accepted invite)
   */
  joined?: number;

  /**
   * Unix timestamp. When the user last opened the thread
   */
  opened?: number;
